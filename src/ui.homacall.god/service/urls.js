...
export const apiUrls = {
  ...
  getAllServiceType: GodHOST.concat('/'),
  insertServiceType: GodHOST.concat('/'),
  updateServiceType: GodHOST.concat('/'),
  deleteServiceType: GodHOST.concat('/'),
  getServiceTypeById: GodHOST.concat('/'),
}
